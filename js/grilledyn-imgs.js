...
var imgsGrid    =   {
    segmentRetenu:  'OPTIN',
    htmlRetenu:  "",
    htmlBuild:  _DATA_IMGS.html_build,
    ...
    affichage:  function(myAmount, mySegment, jQ) {
        ...
        for ( bl in this.htmlRetenu )
        {
            ...
            var Link = 'https://' + _DATA_IMGS.iraiser_url + '/b?cid=' + urlBySegment.getUrl(mySegment, data.amount, _DATA_IMGS);
...
//            HTML = this.replaceAll(HTML, 'data-src', 'src');
        ...
        buildAll:   function(myDebug, myAmount, mySegment, jQ) {
            this.segmentRetenu = (_DATA_IMGS.segments[mySegment] !== undefined) ? mySegment : this.segmentRetenu;
